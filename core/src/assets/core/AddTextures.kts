...
Textures add TextureSprite(get("entities", "clayPot$1Destroyed"), 0f, 1f, z = 0)
Textures add TextureSprite(get("entities", "clayPot$2Destroyed"), 1f, 2f, z = 0)
Textures add TextureSprite(get("entities", "clayPot$3Destroyed"), 4f, 1f, z = 0)
Textures add TextureSprite(get("entities", "clayPot$4Destroyed"), 2f, 1f, z = 0)
...
Textures add TextureSprite(get("entities", "barrelDestroyed"), 0f, 1f, z = 0)
Textures add TextureSprite(get("entities", "crateBiggerDark"), 2f)
Textures add TextureSprite(get("entities", "crateBiggerDarkDestroyed"), z = 0)
Textures add TextureSprite(get("entities", "crateSmall"), 3f)
Textures add TextureSprite(get("entities", "crateSmallDestroyed"), z = 0)
