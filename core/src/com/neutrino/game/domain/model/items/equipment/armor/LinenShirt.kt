...
class LinenShirt: EquipmentItem(), ItemType.EQUIPMENT.TORSO {
    override val name: String = "Linen shirt"
    override val description: String = "Yes"

    override val textureNames: List<String> = listOf("linenShirt")
