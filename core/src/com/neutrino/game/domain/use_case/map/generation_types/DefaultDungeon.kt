...
//
//class DefaultDungeon(level: Level, interpretedTags: TagInterpretation): MapGenerator(level, interpretedTags) {
//
//    override fun generate(): List<List<MutableList<Entity>>> {
//        val squidGeneration = SquidGeneration(level)
//
//        squidGeneration.generateDungeon(TilesetType.DEFAULT_DUNGEON)
